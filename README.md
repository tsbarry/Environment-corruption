...
Using tableau I ploted envirornment health from the epi metric and created a map and base on this visualisation many Aficans nations and some East Asians and one or two from South America have very bad envirnomental health. In the other map in which I created a parameter for countries base on their corruption ranking, there are very few nations with a corruption rank of less than 50. Lastly, after graphing a parametized scatter plot to see the effect of a countries courrption score on air and water health, I can conclude that base on graphs that most countries with a good score tend to have a very good water and air health. However, there are few nations with a bad score with a good water and air health. 
